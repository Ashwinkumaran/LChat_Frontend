MyApplication.controller("ForumCommentController", function($scope, $http,
	...
	function listForumComment() {
		...
		$http.get(
				'http://localhost:8083/LChat_Middleware/listForumComment/'
	...
	function getAForum() {
		...
		$http.get(
				'http://localhost:8083/LChat_Middleware/getForum/'
						+ $rootScope.forumId).then(function(response) {
	...
	$scope.addComment = function() {
		...
		$http.post('http://localhost:8083/LChat_Middleware/addForumComment',
	...
	$scope.deleteComment = function(commentId) {
		$http.get(
				'http://localhost:8083/LChat_Middleware/deleteForumComment/'
